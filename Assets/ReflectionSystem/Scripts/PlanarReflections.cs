...
namespace UnityEngine.Rendering.Universal
{
    ...
    public class PlanarReflections : MonoBehaviour
    {
        ...
        private readonly int _planarReflectionTextureId = Shader.PropertyToID("_ReflectionMap");
        
        [SerializeField] private int wdith = 1920;
        ...
        private void PlanarReflectionTexture(Camera cam)
        {
            if (_reflectionTexture == null)
            {
                ...
                RenderTextureFormat hdrFormat = useHdr10 ? RenderTextureFormat.ARGBFloat : RenderTextureFormat.DefaultHDR;
                _reflectionTexture = RenderTexture.GetTemporary(wdith, height, 16,
